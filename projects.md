  ...
  <div class="case-study-list">
    <article class="case-card">
      <div class="case-card__head">
        <div>
          <div class="tech-stack" aria-label="Stack do projeto"><span>Python</span><span>CLI</span><span>Segurança</span></div>
    ...
    <article class="case-card">
      <div class="case-card__head">
        <div>
          <div class="tech-stack" aria-label="Stack do projeto"><span>Shell Script</span><span>Nmap</span><span>Termux</span></div>
          <h2>PS.Nmap</h2>
        </div>
...
<section class="section-block notice-card">
  ...
  <p>Os projetos e conteúdos são apresentados com finalidade educacional, profissional e de laboratório. Qualquer teste de segurança deve ser realizado apenas em ambientes próprios ou com autorização explícita.</p>
</section>
