...
<section class="ps-public-head">
  ...
  <h1>Apps</h1>
  <p>Inventário técnico de aplicativos e ferramentas do ecossistema PeekSecurity, com foco em privacidade local, produtividade, segurança aplicada, documentação técnica e uso responsável.</p>
...
<section class="ps-workspace">
  <div class="ps-workspace-head">
    ...
    <p class="ps-workspace-subtitle">Cada item é apresentado como uma row técnica, sem cards promocionais e sem prometer recursos não validados.</p>
  </div>
  ...
  <div class="ps-row-list">
    <article class="ps-action-row">
      ...
      <div class="ps-row-copy">
        ...
        <div class="ps-chip-strip">
          ...
          <span class="ps-chip ps-chip-warning">Alpha</span>
        </div>
      </div>
    ...
    <article class="ps-action-row">
      ...
      <div class="ps-row-copy">
        ...
        <p class="ps-row-subtitle">App em fase inicial do ecossistema PeekSecurity. Detalhes públicos serão adicionados conforme houver escopo validado para publicação.</p>
        <div class="ps-chip-strip">
          <span class="ps-chip">Android</span>
          <span class="ps-chip ps-chip-warning">Early base</span>
    ...
    <article class="ps-action-row">
      ...
      <span class="ps-row-trailing">Planned</span>
    </article>
    ...
    <article class="ps-action-row">
      ...
      <span class="ps-row-trailing">Context</span>
    </article>
...
<section class="ps-workspace">
  <div class="ps-workspace-head">
    ...
    <h2 class="ps-workspace-title">Study before executing. Understand before automating.</h2>
    <p class="ps-workspace-subtitle">Document before publishing. Validate before scaling. Use only in owned or authorized environments.</p>
  </div>
</section>
