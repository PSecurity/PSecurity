...
<section class="ps-workspace ps-public-head ps-profile-workspace">
  <div class="ps-workspace-head">
    <p class="ps-section-label">SOBRE</p>
    <div class="ps-public-title" role="heading" aria-level="1">Gilberto Martins</div>
    <p class="ps-workspace-subtitle">Criador da PeekSecurity, graduando em Engenharia de Computação e profissional com experiência em suporte especializado, prevenção a fraudes, análise de crédito e tecnologia.</p>
  </div>
</section>

<section class="ps-workspace ps-profile-workspace">
  <div class="ps-workspace-head">
    <p class="ps-section-label">TRAJETÓRIA</p>
    <div class="ps-workspace-title" role="heading" aria-level="2">Base operacional real aplicada ao portfólio técnico</div>
  </div>
  ...
  <div class="ps-row-list">
    <article class="ps-action-row">
      ...
      <div class="ps-row-copy">
        <div class="ps-row-title" role="heading" aria-level="3">Operação e atendimento especializado</div>
    ...
    <article class="ps-action-row">
      ...
      <div class="ps-row-copy">
        <div class="ps-row-title" role="heading" aria-level="3">Responsabilidade com dados</div>
    ...
    <article class="ps-action-row">
      ...
      <div class="ps-row-copy">
        <div class="ps-row-title" role="heading" aria-level="3">Projetos técnicos autorais</div>
...
<section class="ps-workspace ps-profile-workspace">
  <div class="ps-workspace-head">
    <p class="ps-section-label">MODO DE TRABALHO</p>
    <div class="ps-workspace-title" role="heading" aria-level="2">Clareza, validação e evolução incremental</div>
  </div>
  ...
  <div class="ps-row-list">
    <article class="ps-action-row">
      ...
      <div class="ps-row-copy">
        <div class="ps-row-title" role="heading" aria-level="3">Como penso</div>
    ...
    <article class="ps-action-row">
      ...
      <div class="ps-row-copy">
        <div class="ps-row-title" role="heading" aria-level="3">Como trabalho</div>
    ...
    <article class="ps-action-row">
      ...
      <div class="ps-row-copy">
        <div class="ps-row-title" role="heading" aria-level="3">Onde quero atuar</div>
