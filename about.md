...
<section class="ps-workspace ps-public-head ps-profile-workspace">
  <div class="ps-workspace-head">
    ...
    <h1 class="ps-public-title">Gilberto Martins</h1>
...
<section class="ps-workspace ps-profile-workspace">
  <div class="ps-workspace-head">
    ...
    <h2 class="ps-workspace-title">Base operacional real aplicada ao portfólio técnico</h2>
  </div>
...
<section class="ps-workspace ps-profile-workspace">
  <div class="ps-workspace-head">
    ...
    <h2 class="ps-workspace-title">Clareza, validação e evolução incremental</h2>
  </div>
